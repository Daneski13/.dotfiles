...
# sqlite3 -list "/var/folders/d6/rpd6b_591txdmpf_4f2f21740000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/dane/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/dane/.mailcheckrc"
# }
